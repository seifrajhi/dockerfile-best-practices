...
This repository contains some best-practices for writing Dockerfiles. Most of them are coming from [my experience](https://twitter.com/RajhiSaifeddine) while working with Docker & Kubernetes. 
